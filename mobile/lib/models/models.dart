...
class AttendanceRecord {
  ...
  factory AttendanceRecord.fromMap(Map<String, dynamic> m) => AttendanceRecord(
        ...
        remark: m['remark'] as String?,
        storeId: m['store_id'] as int?,
        checkInLocation: m['check_in_location'] as String?,
        checkOutLocation: m['check_out_location'] as String?,
        checkInLat: m['check_in_lat'] as String?,
        checkInLon: m['check_in_lon'] as String?,
        checkOutLat: m['check_out_lat'] as String?,
        checkOutLon: m['check_out_lon'] as String?,
      );
